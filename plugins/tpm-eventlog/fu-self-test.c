...
static void
fu_test_tpm_eventlog_parse_func (void)
{
	gboolean ret;
	gsize bufsz = 0;
	...
	fn = g_build_filename (TESTDATADIR, "binary_bios_measurements", NULL);
...
main (int argc, char **argv)
{
	...
	g_test_add_func ("/tpm-eventlog/parse", fu_test_tpm_eventlog_parse_func);
	return g_test_run ();
}
