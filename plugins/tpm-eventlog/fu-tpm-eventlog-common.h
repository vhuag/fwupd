...
typedef enum {
	FU_TPM_EVENTLOG_HASH_KIND_SHA1		= 0x0004,
	FU_TPM_EVENTLOG_HASH_KIND_SHA256	= 0x000b
} FuTpmEventlogHashKind;
...
const gchar	*fu_tpm_eventlog_hash_to_string		(FuTpmEventlogHashKind	 hash_kind);
guint32		 fu_tpm_eventlog_hash_get_size		(FuTpmEventlogHashKind	 hash_kind);
